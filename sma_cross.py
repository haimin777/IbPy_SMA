...
class account_ib:
    ...
    def position_handler(self, msg):
        ...
        if msg.typeName == "nextValidId":
            ...
            print(
                "___________order placed__________",
                "\n", "id: ", msg.orderId, "order status: ",
                msg.status)
    ...
    def server_handler(self, msg):
        ...
        if msg.typeName == "updatePortfolio":
            ...
            self.pos_list.append(msg.marketPrice)
                ...
                and msg.key == "LookAheadAvailableFunds-S":
    ...
    def monitor_position(self):  # Отслеживаем открытые позиции и ордера
        ...
        for i in range(0, len(self.list1_orders), 2):
            print(self.list1_orders[i],
                  self.list1_orders[i + 1],
                  self.list2_orders[i],
                  self.list2_orders[i + 1])
        ...
        try:
            ...
            while True:
                ...
                account_ib_r.trade_logic_rand(account_ib_r,
                                              ...
                                              pos_volume)
                try:
                    tws.placeOrder(self.order_ID,
                                   account_ib_r.contract,
