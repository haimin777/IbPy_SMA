...
class Downloader(object):
    def __init__(self, debug=False):
        ...
        self._log.debug(
            'Initializing data dwonloader. Pandas version={0}, ibpy version:{1}'.format(pd.__version__, ib.__version__))
 ...
 #      if self.tws.connect() == False
    ...
    def requestData(self, contract, endDateTime, durationStr='1 D', barSizeSetting='5 mins', whatToShow='MIDPOINT',
